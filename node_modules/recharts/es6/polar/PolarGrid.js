...
var PolarGrid = (0, _PureRender2.default)(_class = (_temp = _class2 = function (_Component) {
  ...
  function PolarGrid(props) {
    ...
    var _this = _possibleConstructorReturn(this, (PolarGrid.__proto__ || Object.getPrototypeOf(PolarGrid)).call(this, props));

    if (!_this.clipId) {
      _this.clipId = 'rechartsPolarGridBgClip' + Date.now();
    }
    return _this;
  }
