...
const GradientScale = ({ width, height, domain, primary, secondary = [], colorScale = 'default' }) => {
  const data = [
        ...
        <defs>
          {
            ...
            ?
              <linearGradient id="myGradient">
                ...
                <stop offset="100%" stopColor={colorScales[colorScale][colorScales[colorScale].length - 1]} />
              </linearGradient>
            :
              <linearGradient id="myGradient">
