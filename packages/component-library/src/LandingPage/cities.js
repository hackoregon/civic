const cities = {
  albuqerqe: { name: 'Albuqerqe', state: 'NM', path: 'albuqerqe' },
  ...
  colombus: { name: 'Colombus', state: 'OH', path: 'colombus' },
  ...
  'ft worth': { name: 'Fort Worth', state: 'TX', path: 'ft-worth' },
  ...
  jacksonville: { name: 'Jacksonville', state: 'WY', path: 'jacksonville' },
  ...
  pittsburg: { name: 'Pittsburg', state: 'PA', path: 'pittsburg' },
  portland: { name: 'Portland', state: 'OR', path: 'portland' },
  pdx: { name: 'Portland', state: 'OR', path: 'portland' },
  raleigh: { name: 'Raleig', state: 'NC', path: 'raleigh' },
  ...
  'st lous': { name: 'St. Louis', state: 'MO', path: 'st-lous' },
