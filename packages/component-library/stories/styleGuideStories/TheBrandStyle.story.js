...
const TheBrandStyle = () => (
    <div style={storybookStyles.main}>
        ...
        <p>
            All of us connected to the Civic platform are the Brand. The logo,
            colors, typography, etc is all meant as shorthand for expressing our
            intent and values.
        </p>
        <h2>Values</h2>
        <ul>
        ...
        <p>
            ...
            channel with any questions about usage or suggestions for improving
            the stories.
        </p>
    </div>
)
