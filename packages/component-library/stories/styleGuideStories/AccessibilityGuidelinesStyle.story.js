...
const AccessibilityGuidelines = () => (
    <div style={storybookStyles.main}>
        ...
        <h4>Cognitive</h4>
        <p>
            Learning disabilities, distractibility, and inability to remember or
        ...
        <p>
            It must be available to the senses, vision and hearing primarily,
        ...
        <p>
            Users can interact with all controls and interactive elements using
        ...
        <p>
            Implementation of the accessibility guidelines can be done using
            this order of priority. Considerations when proposing this order are
            the most common disabilities and the most common features in our
            user interfaces.
        </p>
        <h4>Color Theme</h4>
        <p>
            Meet contrast ratios between text and its background color and
            between colors used to represent distinct information in data
            visualization. WebAIM describes the guidelines and has many examples
        ...
        <p>
            ...
            . The following sections in the tutorials are especially relevant to
            the CIVIC platform.
        </p>
        <ol type="a">
            <li>Labels</li>
        ...
        <p>
            The Forms story has an example of a form that follows our styles and
        ...
        <p>
            ...
            develops web standards; they are led by the Web inventor Tim
            Berners-Lee. One of their initiatives is the{' '}
        ...
        <p>
            The WAI is made up of several working groups and Special Interest
            groups. The most important working group is the{' '}
        ...
        <p>
            Another organization that does a good job of explaining
            accessibility and the guidelines is{' '}
