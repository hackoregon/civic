...
const TempVoterRegistration = () =>
  <StoryCard title="Voter Registration Data" collectionId="housing" cardId="voter-registration">
    <div style={wrapperStyle}>
      ...
      <p>
        ...
        live: Portland is aging, but the age at which citizens register to vote for the first time
        is growing younger. Perhaps in response to rising housing costs, more adults are living in
        shared households, and more of those adults appear to be adult children living with their
        parents into their late 20s.
      </p>
      ...
      <p>
        ...
        Portland is still a relatively young city, the share of seniors in the population has been
        growing rapidly, in part reflecting the aging of “young and well-educated people who moved
        to Oregon in the 1970s.” According to&nbsp;
        ...
        Portland State University, “There’s a lot of young, well-educated people who have been
        coming here since the ’90s, but they were coming here in the ’70s, too.” Seniors who have
        moved to Portland more recently may also be&nbsp;
      ...
      <p>
        ...
        moving in with their adult children. And still others are unrelated adults living in shared
        housing, possibly in more homogeneous age groups. Further research using this Voter
        Registration data set would allow us to identify what proportion of shared households are
        made up of extended families versus other types of relationships.
      </p>
      <img
        style={imgStyle}
      ...
      <p>
        ...
        , in 2014, for the first time since the 1940s, 32.1% of adults ages 18 to 34 were living in
        a parents’ home. However, the past 15 years have also seen an increase in young adults
        adapting many different ways of living, “with the decline of romantic coupling pushing
      ...
      <p>
        ...
        middle and upper middle class families located closer to the city center are choosing to
      ...
      <p>
        ...
        help shed light on the factors leading to this surprising shift.
      </p>
      <img
        style={imgStyle}
