 ...
 */
const orderNeighborhoods = neighborhoods =>
 ...
 */
const associateOtherAffordability = (neighborhoods, affordability) =>
 ...
 */
const associateYourAffordability = (neighborhoods, rent, income) =>
  rent.reduce(
    (accum, { rent_amt, id }) =>
      adjust(
        neighborhood => ({
 ...
 */
const associateNeighborhoodsData = (
  neighborhoods,
  affordability,
  rent,
  income
