...
const DoubledUp = props => {
  ...
  return (
    <div>
      ...
      <p style={shared.text}>
        The HUD definition of people experiencing homelessness does not include
        the majority of people who lack stable housing—people who are
        temporarily sheltering in basements, spare rooms, or on the couches of
