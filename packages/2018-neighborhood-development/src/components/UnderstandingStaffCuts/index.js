    ...
    return (
      ...
      >
        <Collapsable>
          <Collapsable.Section>
            <div>
              <p>Portland Public Schools (PPS) parents received an email explaining proposed staffing changes in mid-April, 2018. Hack Oregon conducted an analysis of these changes using PPS’s stated goals listed below.
              <ul>
...
UnderstandingStaffCuts.propTypes = {
  ...
  understandingStaffCuts: PropTypes.arrayOf(PropTypes.object),
};
