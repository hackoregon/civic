...
export class MagnitudeOfUrbanCampsiteSweeps extends React.Component {
  ...
  render() {
    const { isLoading, error, magnitudeOfUrbanCampsiteSweeps } = this.props;
      ...
      >
        <Collapsable>
          <Collapsable.Section>
            <div>
              <p>
                ...
                reports intersections of all posted sweeps of campsites in a
                given week. This visualization counts the total number of
                reported sweeps. Portland has had an average of 112.4 sweeps per
                month, and the amount of sweeps has increased significantly over
                time.
              </p>
          ...
          <Collapsable.Section hidden>
            <div>
              <p>
                Camping, whether for recreation or for survival, is not
                permitted in the City of Portland (City Code 14A.50.020 and
                14A.50.). To enforce this, the City posts signs 24 hours in
                advance of a campsite clean-up, or ‘sweep’. Any property that
                remains after 24 hours is picked up and stored in a facility for
                30 days.
              </p>
              <p>
              ...
              <p>
                ...
                of 311 sweeps in one month during October, 2017. The past 8
                months have all been above the average for sweeps, showing that
                the trend of rising sweeps is consistent.
              </p>
              <p>
                ...
                description of the surrounding area, as well as predicted
                clean-up sites for future weeks. This collection quantifies and
                maps this data for the first time, to our knowledge.
              </p>
            </div>
          </Collapsable.Section>
        </Collapsable>
