...
const ENDPOINT_BASE = 'http://service.civicpdx.org/neighborhood-development/api/school_class_size?format=json&limit=100';

export const fetchclassAndSizeQuality = year => apiAdapter(
  `${ENDPOINT_BASE}&year=${year}`,
  {
