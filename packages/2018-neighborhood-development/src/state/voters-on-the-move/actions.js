...
export const API_START = "VOTERS_ON_THE_MOVE/START";
export const API_SUCCESS = "VOTERS_ON_THE_MOVE/SUCCESS";
export const API_ERROR = "VOTERS_ON_THE_MOVE/ERROR";
export const AWAY_API_START = "VOTERS_ON_THE_MOVE/AWAY_START";
export const AWAY_API_SUCCESS = "VOTERS_ON_THE_MOVE/AWAY_SUCCESS";
export const AWAY_API_ERROR = "VOTERS_ON_THE_MOVE/AWAY_ERROR";
...
const endpoint =
  "api/voter_movement_points?limit=1000&random=1&direction=center&format=json";
const awayEndpoint =
  "api/voter_movement_points?limit=1000&random=1&direction=away&format=json";

export const fetchVotersOnTheMove = apiAdapter(endpoint, {
  start: VotersOnTheMoveStart,
  success: VotersOnTheMoveSuccess,
  failure: VotersOnTheMoveError
});

export const fetchAwayVotersOnTheMove = apiAdapter(awayEndpoint, {
