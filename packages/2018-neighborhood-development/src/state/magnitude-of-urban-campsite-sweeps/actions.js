...
export const API_START = 'MAGNITUDE_OF_URBAN_CAMPSITE_SWEEPS/START';
export const API_SUCCESS = 'MAGNITUDE_OF_URBAN_CAMPSITE_SWEEPS/SUCCESS';
export const API_ERROR = 'MAGNITUDE_OF_URBAN_CAMPSITE_SWEEPS/ERROR';
...
export const fetchUrbanCampsiteSweepsByWeek = apiAdapter(endpoint, {
