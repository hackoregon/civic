...
export const API_START = 'UNDERSTANDING_STAFF_CUTS/START';
export const API_SUCCESS = 'UNDERSTANDING_STAFF_CUTS/SUCCESS';
export const API_ERROR = 'UNDERSTANDING_STAFF_CUTS/ERROR';
...
export const fetchUnderstandingStaffCuts = apiAdapter(endpoint, {
