...
export const getSelectedNeighborhood = createSelector(
  ...
  ({ selectedNeighborhood }) =>
    selectedNeighborhood && selectedNeighborhood.value
);

const getNeighborhoodsFromData = data => data.map(obj => obj.neighborhood);
const getSelectedNeighborhoodData = (data, nbhd) =>
...
const dataForNeighborhood = (data, nbhd) =>
...
export const getDataForSelectedNeighborhood = createSelector(
  ...
  (data, nbhd) =>
    !!data && !!nbhd && formatData(dataForNeighborhood(data, nbhd))
);
