...
import DemoEducationVisualization from "./DemoEducationVisualization";

const DemoEducationMeta = (/* data */) => ({
  title: "Demo Education",
  slug: "demo-education-card",
  introText: (
    <p>
  ...
  visualization: DemoEducationVisualization, // data, isLoading are passed to this as props
  additionalText: (
    <p>
...
export default DemoEducationMeta;
