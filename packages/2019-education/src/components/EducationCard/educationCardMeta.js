...
import EducationCardVisualization from "./EducationCardVisualization";

const educationCardMeta = (/* data */) => ({
  title: "(Story Card #1, Issue #000) Education Card Title",
  slug: "education-card",
  introText: (
    <p>
  ...
  visualization: EducationCardVisualization,
  additionalText: (
    <p>
...
export default educationCardMeta;
