...
import ElectionsCardVisualization from "./ElectionsCardVisualization";

const electionsCardMeta = (/* data */) => ({
  title: "(Story Card #1, Issue #000) Elections Card Title",
  slug: "elections-card",
  introText: (
    <p>
  ...
  visualization: ElectionsCardVisualization,
  additionalText: (
    <p>
...
export default electionsCardMeta;
