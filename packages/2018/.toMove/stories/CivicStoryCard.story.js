...
import { WallOfRichText, wallOfText } from "@hackoregon/utils";
import { HorizontalBarChart } from "@hackoregon/ui-charts";
...
export default () =>
  storiesOf("Projects/civicplatform•org/CIVIC Story Card", module)
    .add(
      "Simple usage",
