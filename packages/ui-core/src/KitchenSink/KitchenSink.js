    ...
    <main>
      <article>
        ...
        <p>
          ...
          <abbr title="Abbr">Similique dolor aut magni</abbr> ipsam id unde nam
          sit. Veritatis quis officia aut est cumque nam beatae.{" "}
          <sub>Itaque</sub> mollitia ut sed.{" "}
          <em>Rem fuga modi voluptatibus voluptas incidunt.</em> Eius sed
          officia non modi.
        </p>

        <p>
          Quis reprehenderit possimus nam illo. Iure ut magnam dolore laborum et
          non omnis.{" "}
        ...
        <blockquote>
          <p>
            Fugiat culpa deserunt est tempore officiis reiciendis. Distinctio
            dolor sunt hic. Facilis aut sunt et et molestias dolore.
          </p>
          <footer>
            <cite>-aperiam</cite>
          </footer>
        ...
        <p>
          ...
          unde. Magni velit est labore. <code>Omnis dolores minima</code> nobis
          non nihil ipsam nisi voluptas expedita.
        </p>
          ...
          <div>
            <label htmlFor="text1">
              ...
              <input
                type="text"
                id="text1"
                placeholder="voluptatem et inventore"
              />
            </label>
          </div>
          <div>
