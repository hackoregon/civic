...
import TemplateMinimalCardVisualization from "./TemplateMinimalCardVisualization";

const TemplateMinimalCardMeta = (/* data */) => ({
  title: "Template Minimal Card",
  slug: "template-minimal-card",
  introText: (
    <p>
      This template card relies on no large sources of data. It is purely
      presentational and requires no app state
    </p>
  ),
  visualization: TemplateMinimalCardVisualization, // data, isLoading are passed to this as props
  additionalText: (
    <p>
