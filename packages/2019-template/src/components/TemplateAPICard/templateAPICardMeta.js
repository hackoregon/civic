...
import TemplateAPICardVisualization from "./TemplateAPICardVisualization";

const TemplateAPICardMeta = (/* data */) => ({
  title: "(Story Card #1, Issue #000) Template API Card Title",
  ...
  visualization: TemplateAPICardVisualization, // data, isLoading are passed to this as props
  additionalText: (
    <p>
  ...
  // tags: ["Transportation", "Bus", "Rail", "Portland", "Stuff"],
  selector: null,
  analysis: (
    <Collapsable>
      <Collapsable.Section>
