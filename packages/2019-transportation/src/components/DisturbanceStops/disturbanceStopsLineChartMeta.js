...
import DisturbanceStopsLineChartVisualization from "./DisturbanceStopsLineChartVisualization";

const DisturbanceStopsMeta = (/* data */) => ({
  title: "Total Time of Disturbance Stops",
  ...
  visualization: DisturbanceStopsLineChartVisualization, // data, isLoading are passed to this as props
  additionalText: (
    <p>
