...
exports.default = {
  plugins: (0, _utils.removeEmpty)([new _webpack2.default.LoaderOptionsPlugin({ options: { postcss: [_autoprefixer2.default] } }), _utils.isProd && new _webpack2.default.LoaderOptionsPlugin({
    minimize: true,
    debug: false
