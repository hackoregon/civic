...
const HomePage = () => (
  <div>
    <div className={`${styles.Platform} Hero ${styles.Hero}`} id={styles.Hero} name={styles.Hero}>
      <div className="Container">
        <div className={`${styles.Content} Content`}>
          <h1 className="step1">CIVIC<br />is an<br />open<br />platform</h1>
          <h1 className="step2">CIVIC<br />is a<br />data<br />platform</h1>
          <h1 className="step3">CIVIC<br />is a<br />public<br />platform</h1>
          <h1 className="step4">CIVIC<br />is an<br />engaged<br />platform</h1>
          <h1 className="step5">CIVIC<br />is an<br />insightful<br />platform</h1>
          <h1 className="step6">CIVIC<br />is a<br />human<br />platform</h1>
        </div>
      </div>
    </div>
    ...
    <div className={`${styles.Collection} ${styles.Hero} Hero EmergencyResponse`}>
      <div className="Container">
        <div className={`${styles.Content} Content`}>
