...
const purpleGreenDivergent = [[115, 41, 125, 255], [149, 86, 156, 255], [181, 139, 186, 255], [214, 193, 217, 255], [215, 215, 215, 255], [192, 227, 213, 255], [135, 205, 179, 255], [77, 184, 144, 255], [18, 164, 110, 255]];
...
const foundation042GetColor = (f) => {
  ...
  return value <= -100 ? purpleGreenDivergent[0] :
    value <= -75 ? purpleGreenDivergent[1] :
    value <= -50 ? purpleGreenDivergent[2] :
    value <= -25 ? purpleGreenDivergent[3] :
    value <= 25 ? purpleGreenDivergent[4] :
    value <= 50 ? purpleGreenDivergent[5] :
    value <= 75 ? purpleGreenDivergent[6] :
    value <= 100 ? purpleGreenDivergent[7] :
    value <= 1500 ? purpleGreenDivergent[8] :
    [0, 0, 0, 100];
};
...
const ridershipRouteGetColor = (f) => {
  ...
  return value <= -100 ? purpleGreenDivergent[0] :
    ...
    value <= 75 ? purpleGreenDivergent[6] :
    value <= 100 ? purpleGreenDivergent[7] :
    value < 9999 ? purpleGreenDivergent[8] :
    [255, 255, 255, 0];
};
