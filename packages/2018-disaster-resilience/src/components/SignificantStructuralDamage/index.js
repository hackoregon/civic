      ...
      >
        <Collapsable>
          ...
          <Collapsable.Section hidden>
            <div>
              <p>
                Portland’s bridges are essential for transporting people, goods,
                and services across the Willamette River every day. Of
              ...
              <p>
                The Portland Airport is located in an area which will be
                significantly impacted by shaking and liquefaction, so airport
                runways are likely to be highly deformed and unusable after a
                Cascadia quake. The airport does not currently have a plan to
                restore operations quickly after an earthquake, which will make
                it difficult to deliver needed people and resources to the
                region.
              </p>
              <p>
                Between the Fremont Bridge and Sauvie Island is Oregon’s
                “Critical Energy Infrastructure”, containing most of Oregon’s
                facilities for receiving, storing, transporting liquid fuel and
                natural gas. Although these facilities are built on land at very
                high risk for liquefaction and landslides, few structures have
                been retrofitted to meet current building standards. Most of
                this infrastructure will not be functional after a Cascadia
                quake, which means that a state or region-wide fuel shortage is
                a real possibility.
              </p>
            </div>
          </Collapsable.Section>
