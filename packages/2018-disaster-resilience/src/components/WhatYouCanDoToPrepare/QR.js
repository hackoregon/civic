const QRMap = [
  {
    ...
    note:
      "A plan should include a family meeting place, a travel plan from work and school, and include day and nighttime contingencies.",
    shortRecommendation:
      "Make a disaster plan with your family that includes safe places to meet and how everyone will get there. ",
    longRecommendation:
      "Make a family disaster action plan\n" +
  ...
  },
  {
    ...
    note:
      "Knowing your neighbors makes your neighborhood safer and more resilient. Since first responders cannot be everywhere after a disaster, neighbors will likely be the first ones to help those in need.\n",
    shortRecommendation:
      "Get to know at least 3 neighbors and build a community for support in time of a disaster. ",
    longRecommendation:
      "Know Your Neighbors\n" +
  ...
  },
  {
    ...
    note:
      "It should include 3 days of supplies, including water, food, an AM/FM emergency radio with extra batteries, basic first aid, and some kind of blankets or shelter. It will provide for your family in the event that you cannot stay in your home.\n",
    shortRecommendation:
      "Buy or make an evacuation kit that will last your family three days.",
    longRecommendation:
  ...
  },
  {
    ...
    note:
      "Water supplies for 2 weeks will require 14 gallons of water per person in your household. Food supplies can include all kinds of non-perishable items, such as canned food, freeze-dried, and MREs.",
    shortRecommendation:
  ...
  },
  {
    ...
    note:
      "After a major disaster, water and sewer infrastructure will not be functional for some time. A 2-bucket toilet system keeps human waste sterile and secure and populations healthy.",
    shortRecommendation:
      "Make a two bucket system to seperate human waste from clean water.",
    longRecommendation:
  ...
  },
  {
    ...
    note:
      "Securing your house should include strapping tall, heavy furniture to the wall and moving heavy mirrors or art pieces away from beds and desks.",
    shortRecommendation:
  ...
  },
  {
    ...
    note:
      "It is likely that cell phones will not work for some time after a disaster. Walkie-talkies and hand-held AM/FM radios will be a good way to communicate. The city of Portland has a plan for two-way radio communications across the city called BEECN.",
    shortRecommendation:
      "Form a communication plan with you family. Plan to use two-way radios instead of cell phones.",
    longRecommendation:
  ...
  },
  {
    questionId: 8,
    question:
      "Have you considered becoming a neighborhood resilience champion?",
    note:
    ...
    shortRecommendation:
      "Consider becoming a Neighborhood Emergency Team volunteer.",
    longRecommendation:
