        ...
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          ...
          >
            ...
            <table style={{ borderSpacing: "10px" }}>
              <tr>
                <td style={{ color: "#D5135F" }}>
                  {stats.fma_population_total}
                </td>
                <td>population</td>
              </tr>
              <tr>
              ...
              <tr>
                <td style={{ color: "#D5135F" }}>
                  {(stats.percent_non_white * 100).toFixed(2)}%
                </td>
                <td>non-white</td>
              </tr>
              <tr>
                <td style={{ color: "#D5135F" }}>
                  {(stats.percent_total_lesh * 100).toFixed(2)}%
                </td>
                <td>limited english proficiency</td>
              </tr>
              <tr>
                <td style={{ color: "#D5135F" }}>
                  {(stats.percent_below_pov * 100).toFixed(2)}%
                </td>
                <td>households below poverty line</td>
              </tr>
              <tr>
                <td style={{ color: "#D5135F" }}>
                  {(stats.percent_renter_occ_hh * 100).toFixed(2)}%
                </td>
                <td>percent renters</td>
              </tr>
              <tr>
                <td style={{ color: "#D5135F" }}>
                  {(stats.percent_owner_occ_hh * 100).toFixed(2)}%
                </td>
          ...
          >
            ...
            <table style={{ borderSpacing: "10px" }}>
              <tr>
                <td style={{ color: "#D5135F" }}>
                  {stats.weekly_total_incs.toFixed(2)}
                </td>
                <td>overall</td>
              </tr>
              <tr>
                <td style={{ color: "#D5135F" }}>
                  {stats.weekly_med_incs.toFixed(2)}
                </td>
                <td>medical</td>
              </tr>
              <tr>
                <td style={{ color: "#D5135F" }}>
                  {stats.weekly_fire_incs.toFixed(2)}
                </td>
                <td>fire</td>
              </tr>
            </table>
          ...
          >
            ...
            <div style={{ display: "flex" }}>
              <table style={{ borderSpacing: "10px" }}>
                <tr>
                  <td style={{ color: "#D5135F" }}>
                    {stats.median_response_time.toFixed(2)} min
                  </td>
                  <td>overall</td>
                </tr>
                <tr>
                  <td style={{ color: "#D5135F" }}>
                    {stats.median_resp_time_med.toFixed(2)} min
                  </td>
                  <td>medical</td>
                </tr>
                <tr>
                  <td style={{ color: "#D5135F" }}>
                    {stats.median_resp_time_fire.toFixed(2)} min
                  </td>
                  <td>fire</td>
                </tr>
              </table>
