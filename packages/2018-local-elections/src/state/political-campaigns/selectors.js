...
export const getContributorBreakdownData = createSelector(
  ...
  ({ data }) =>
    data.contributorBreakdown && data.contributorBreakdown.data
      ? data.contributorBreakdown.data
      : data.contributorBreakdown
);

export const getSpendingBreakdownData = createSelector(
  politicalCampaignsSelector,
  ({ data }) =>
    data.spendingBreakdown && data.spendingBreakdown.data
...
export const isPoliticalCampaignsLoading = createSelector(
  ...
  ({ data }) =>
    !!(
      (data.committees && data.committees.pending) ||
      (data.electionCycles && data.electionCycles.pending)
    )
);
...
export const getElectionCycles = createSelector(
  politicalCampaignsSelector,
  ({ data }) =>
    data.electionCycles && data.electionCycles.data
      ? data.electionCycles.data
      : data.electionCycles
);
...
export const getCommittees = createSelector(
  politicalCampaignsSelector,
  ({ data }) =>
    data.committees && data.committees.data
