...
var defaultMenu = ['Collections', 'Explore', 'About'];
...
var Nav = function Nav(_ref) {
  ...
  return _react2.default.createElement(
    ...
    menu.map(function (item, idx) {
      return _react2.default.createElement(_NavRouterLink2.default, { style: { flex: '1 1 100%' }, key: idx, name: item.name, path: item.path });
    })
  );
};
